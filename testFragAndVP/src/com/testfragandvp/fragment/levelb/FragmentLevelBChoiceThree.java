...
public class FragmentLevelBChoiceThree extends Fragment implements OnClickListener {
	...
	private void setView() {
		...
		String issureContent = LevelBActivity.issureContent[2];
		tvIssure.setText(issureContent);
		String[] choiceContent = LevelBActivity.answerContent[2].split(";");
		choiceSoundContent = LevelBActivity.choiceSoundContent[2].split(";");
	...
	public class AnswerAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			holder.btnOptions.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ActivityBiz.changeChoiceLevelBStatus(2, position);
				}
			});
		...
		public void handleImageView(Button btn, int pos) {
			...
			currentBtn = btn;
			// 可能存在内存问题， 不能够及时释放
			FragmentLevelBChoiceThree.adapter.notifyDataSetChanged();
		}
