...
public class FragmentChoiceTwo extends Fragment implements OnClickListener {
	...
	private void setView() {
		...
		String issureContent = MainActivity.issureContent[1];
		tvIssure.setText(issureContent);
		String[] choiceContent = MainActivity.answerContent[1].split(";");
		choiceSoundContent = MainActivity.choiceSoundContent[1].split(";");
	...
	public class AnswerAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			holder.btnOptions.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ActivityBiz.changeChoiceStatus(1, position);
				}
			});
		...
		public void handleImageView(Button btn, int pos) {
			...
			currentBtn = btn;
			// 可能存在内存问题， 不能够及时释放
			FragmentChoiceTwo.adapter.notifyDataSetChanged();
		}
