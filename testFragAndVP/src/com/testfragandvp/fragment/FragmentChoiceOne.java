...
public class FragmentChoiceOne extends Fragment implements OnClickListener {
	...
	public void setUserVisibleHint(boolean isVisibleToUser) {
		...
		if (isVisibleToUser) {
			...
			if (MainActivity.isFirstEnter) {
				MainActivity.isFirstEnter = false;
				// 提示语
				playSoundMusic(BaseCommon.path_game + "question_prologue.mp3");
			}
		} else {
			// 相当于Fragment的onPause
			clearMediaPlayer();
	...
	private void setView() {
		...
		String issureContent = MainActivity.issureContent[0];
		tvIssure.setText(issureContent);
		System.out.println("new MainActivity().answerContent[0] :"
				+ MainActivity.answerContent[0]);
		String[] choiceContent = MainActivity.answerContent[0].split(";");
		choiceSoundContent = MainActivity.choiceSoundContent[0].split(";");
		...
		public View getView(final int position, View convertView,
			...
			holder.btnOptions.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					ActivityBiz.changeChoiceStatus(0, position);
				}
			});
