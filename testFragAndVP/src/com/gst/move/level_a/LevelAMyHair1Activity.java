 ...
 *
 */
public class LevelAMyHair1Activity extends BaseActivity implements OnClickListener {
	...
	private String[] picArray = new String[] {
			"my_hair_bg", "my_hair_mother", "my_hair_father"
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_hair_1);
	...
	private void init() {
		mContext = LevelAMyHair1Activity.this;
		scaleQPW = (width / 1280.0f);
		scaleQPH = (height / 720.0f);

		biz = new VideoBiz();
		path = ConstantEp.path_level_a_game + "my_hair_1.mp4/";
	...
	private void setView() {
		...
		// 播放题目读音
		MediaPlayerBiz.playSoundMusic(ConstantEp.path_level_a_game + "my_hair_problem_1.mp3", null);
	}
	
	private void setViewPosition(View iv, int i) {
		biz.setViewPosition(iv, i, FixedPositionLevelA.my_hair_position,
