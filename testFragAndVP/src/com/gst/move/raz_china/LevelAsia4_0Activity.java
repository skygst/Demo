package com.gst.move.raz_china;
 ...
 * @author
 */
public class LevelAsia4_0Activity extends BaseActivity implements
		OnClickListener {
	/*-----------------基础----------------------*/
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.asia_level4_0);
	...
	private void initializationData() {
		mContext = LevelAsia4_0Activity.this;
...
//		CommonUtil.downLoadCountryRes(mContext, commonPath, 2, 3);
	}
...
//				startActivity(new Intent(mContext, CountryPassOverActivity.class).putExtra("level", 1).putExtra("countryIndex", 14));
				finish();
				break;
			case 4:
