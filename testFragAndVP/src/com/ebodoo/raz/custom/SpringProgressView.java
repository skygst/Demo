...
//    private static final int[] SECTION_COLORS = {Color.GREEN, Color.GREEN, Color.GREEN};
    private static final int[] SECTION_COLORS = {Color.parseColor("#78d54f"),
            Color.parseColor("#78d54f"), Color.parseColor("#78d54f")};
    /**进度条最大值*/
...
//        mPaint.setColor(Color.rgb(217, 217, 217));
        mPaint.setColor(Color.argb(0, 0, 0, 0));
        RectF rectBg = new RectF(0, 0, mWidth, mHeight);
        canvas.drawRoundRect(rectBg, round, round, mPaint);
//        mPaint.setColor(Color.BLACK);
//        mPaint.setColor(Color.YELLOW);
        mPaint.setColor(Color.parseColor("#f3eba9"));
