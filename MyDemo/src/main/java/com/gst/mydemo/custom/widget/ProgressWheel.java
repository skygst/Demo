...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		barLengthValue = (int) a.getDimension(R.styleable.ProgressWheel_barLengthValue, barLengthValue);
	...
	protected void onDraw(Canvas canvas) {
		...
		// Draw the bar
		if (isSpinning) {
			canvas.drawArc(circleBounds, progress - 90, barLengthValue, false, barPaint);
		} else {
