...
public class XRTextView extends TextView {
	...
	public XRTextView(Context context, AttributeSet attrs) {
		...
		textSize = attrs.getAttributeIntValue(namespace, "textSize", dip2px(context, 20.0f));// 字体大小
		...
		marginLeft = attrs.getAttributeIntValue(namespace, "marginLeft", 10);
	...
	protected void onDraw(Canvas canvas) {
		...
		System.out.println("onDraw textShowWidth :" + textShowWidth);
		int lineCount = 0;
